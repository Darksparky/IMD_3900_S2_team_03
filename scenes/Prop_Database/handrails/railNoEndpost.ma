...
//Last modified: Fri, Nov 06, 2020 10:05:48 PM
//Codeset: 1252
requires maya "2019";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.9475683721309907 2.2174352735210761 4.0391312822284657 ;
	setAttr ".r" -type "double3" -18.938352728847974 370.99999999972653 -4.0501051915273021e-16 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "34A25E0C-4BB0-4645-A8AD-60B07F8FDCF8";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "361D4811-4E8B-F6A5-E723-DF9E84F78DD3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DB4D1C54-4524-CA0A-3D91-918ED4DA4D34";
createNode displayLayerManager -n "layerManager";
	rename -uid "03D9ED7B-4158-5866-01A4-BDA1E46D9F05";
createNode displayLayer -n "defaultLayer";
	rename -uid "864B4277-4D18-FB30-B1BC-0D99012CB3A4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E852AEF8-45F0-6D99-B9D0-BBA83AC7F6E6";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "2F654B4A-43AC-B12F-2DA5-B28577D31303";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1011.3819200027773 -721.74348354019344 ;
	setAttr ".tgi[0].vh" -type "double2" 1113.0825962336644 500.68025221359784 ;
	...
	setAttr ".tgi[0].ni[2].x" -862.85711669921875;
	...
	setAttr ".tgi[0].ni[5].x" 690.25689697265625;
	setAttr ".tgi[0].ni[5].y" -181.03800964355469;
	...
	setAttr ".tgi[0].ni[10].x" -161.42857360839844;
	setAttr ".tgi[0].ni[10].y" -475.71429443359375;
	setAttr ".tgi[0].ni[10].nvs" 1923;
	setAttr ".tgi[0].ni[11].x" -137.14285278320313;
	...
	setAttr ".tgi[0].ni[13].y" 365.71429443359375;
...
connectAttr "place2dTexture2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "handrail_mat.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
